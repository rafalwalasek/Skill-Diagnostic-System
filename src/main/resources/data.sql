...
-- (4, 'Napastnik wcześniej już napomniany w zawodach nadmiernie fetuje zdobycie bramki (zakrywa twarz maską) po tym, jak udało mu się wyrównać wynik meczu. Jaką decyzje podejmie sędzia jeżeli uzna on wskazanie swojego asystenta, na podstawie którego bramka zostanie nieuznana z tytułu wcześniej zaistniałego spalonego?', '+', 'P', 'P + ++', 'S', 'C', 'MEDIUM');
-- ('', '', '', '', '', '', '', '');
